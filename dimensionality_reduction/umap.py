# dimensionality_reduction/umap.py
import pickle
import numpy as np
...
sil_score = silhouette_score(Z_umap, kmeans_labels)
...
# --- Plot UMAP result (color by cluster, style by label) ---
...
plt.title("UMAP of CLAP Scores - K-means Clusters")
plt.xlabel("UMAP 1")
plt.ylabel("UMAP 2")
plt.grid(True)
...
with open("dimensionality_reduction/umap_2d.pkl", "wb") as f:
